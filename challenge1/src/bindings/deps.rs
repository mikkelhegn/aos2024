...
pub mod advent_of_spin {
  ...
  pub mod challenge_two {
    ...
    pub mod non {
      ...
      pub fn get_naughty_or_nice_score(num: u8,) -> u8{
        unsafe {

          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "advent-of-spin:challenge-two/non")]
          extern "C" {
            #[link_name = "get-naughty-or-nice-score"]
            fn wit_import(_: i32, ) -> i32;
          }

          #[cfg(not(target_arch = "wasm32"))]
          fn wit_import(_: i32, ) -> i32{ unreachable!() }
          let ret = wit_import(_rt::as_i32(&num));
          ret as u8
        }
      }
...
pub mod exports {
  ...
  #[doc(hidden)]
  pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1050] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9f\x07\x01A\x02\x01\
A\x06\x01B#\x01r\x03\x06modules\x08protocols\x04names\x04\0\x07bundled\x03\0\0\x01\
...
0.1.0\x05\x01\x01B\x02\x01@\x01\x03num}\0}\x04\0\x19get-naughty-or-nice-score\x01\
\0\x03\0\x20advent-of-spin:challenge-two/non\x05\x02\x04\0\x19spin-deps:deps/dep\
s@0.1.0\x04\0\x0b\x0a\x01\0\x04deps\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
